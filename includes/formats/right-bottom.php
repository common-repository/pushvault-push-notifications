...
<div id='pvl-ask-permision-modal' name='pvl-ask-permision-modal' class='pvl-ask-permision-modal-right-bottom'>
	<div class='pvl-sub-modal-right-bottom'>
...
jQuery(function(){
		if(PushVault.isCompatible() && getPvltCookie() != 1){
			setTimeout(function(){
				...
				jQuery('#pvl-ask-permision-modal').animate({"right": "0px"}, "500");
			}, <?= $pvlTimer ?>);
		}else{
...
jQuery('#pvl-cancel-button').click(function() {
	jQuery('#pvl-ask-permision-modal').animate({"right": "-410px"}, "500");	
