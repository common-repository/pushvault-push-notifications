...
<div id='pvl-ask-permision-modal' name='pvl-ask-permision-modal'  class='pvl-ask-permision-modal-central'>
	<div class='pvl-sub-modal-central'>
...
jQuery(function(){
	if(PushVault.isCompatible() && getPvltCookie() != 1){
		setTimeout(function(){
			...
			jQuery('#pvl-ask-permision-modal').show();
			jQuery('#pvl-ask-permision-modal').fadeTo("fast",1);
		}, <?= $pvlTimer ?>);
	}else{
...
jQuery('#pvl-cancel-button').click(function() {
	jQuery('#pvl-ask-permision-modal').fadeTo("fast",0);
